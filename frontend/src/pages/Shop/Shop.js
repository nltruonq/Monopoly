    ...
    <>
      <div className={cx("shop")}>
        ...
        <div className={cx("wrapper")}>
          ...
          <button className={cx("btn-buy1")}>Mua</button>
        </div>
        <button className={cx("btn-back")} onClick={handleClickBack}>
        ...
        <div className={cx("wrapper")}>
          ...
          <button className={cx("btn-buy2")}>Mua</button>
        </div>
        <div className={cx("wrapper")}>
          ...
          <button className={cx("btn-buy3")}>Mua</button>
        </div>
        <div className={cx("wrapper")}>
          ...
          <button className={cx("btn-buy4")}>Mua</button>
        </div>
      </div>
    </>
  );
